...
//--------------------------------------------------------------
void RammsyMesh::setup(){
    
    image.loadImage("rammsy_end.jpg");
    image.resize(200, 200);
    mesh.setMode(OF_PRIMITIVE_LINES);
    
    float intensityThreshold = 80;
...
//--------------------------------------------------------------
void RammsyMesh::keyPressed(int key){
...
void RammsyMesh::sendControlChange(ofxMidiMessage &controlMesssage) {
...
//--------------------------------------------------------------
void RammsyMesh::keyReleased(int key){
    
}

//--------------------------------------------------------------
void RammsyMesh::mouseMoved(int x, int y ){
    
}

void RammsyMesh::mouseDragged(int x, int y, int button){
    
}

//--------------------------------------------------------------
void RammsyMesh::mousePressed(int x, int y, int button){
    
}


//--------------------------------------------------------------
void RammsyMesh::mouseReleased(int x, int y, int button){
    
}

//--------------------------------------------------------------
void RammsyMesh::windowResized(int w, int h){
    
}

//--------------------------------------------------------------
void RammsyMesh::gotMessage(ofMessage msg){
    
}

//--------------------------------------------------------------
void RammsyMesh::dragEvent(ofDragInfo dragInfo){
