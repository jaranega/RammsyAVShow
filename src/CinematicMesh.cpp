...
//--------------------------------------------------------------
void CinematicMesh::setup(){
    
    image.loadImage("Cynematic.jpg");
...
void CinematicMesh::sendControlChange(ofxMidiMessage &controlMesssage) {
...
//--------------------------------------------------------------
void CinematicMesh::keyPressed(int key){
...
//--------------------------------------------------------------
void CinematicMesh::keyReleased(int key){
    
}

//--------------------------------------------------------------
void CinematicMesh::mouseMoved(int x, int y ){
    
}

void CinematicMesh::mouseDragged(int x, int y, int button){
    
}

//--------------------------------------------------------------
void CinematicMesh::mousePressed(int x, int y, int button){
    
}


//--------------------------------------------------------------
void CinematicMesh::mouseReleased(int x, int y, int button){
    
}

//--------------------------------------------------------------
void CinematicMesh::windowResized(int w, int h){
    
}

//--------------------------------------------------------------
void CinematicMesh::gotMessage(ofMessage msg){
    
}

//--------------------------------------------------------------
void CinematicMesh::dragEvent(ofDragInfo dragInfo){
